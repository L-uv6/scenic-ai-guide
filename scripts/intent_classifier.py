...
TIME_CLASH_PATTERNS = [
    # 鲁迅 + 现代事物
    r"(鲁迅|您|你).*(用过|见过|参加|玩过|看过|知道).*(手机|电脑|网络|电视|电影|汽车|飞机|人工智能|机器人|抖音|微信|互联网|直播|综艺|游戏|动漫)",
    r"(鲁迅|您|你).*(有没有|是否有|有过|是否).*(手机|电脑|网络|电视|飞机|人工智能|机器人|微信|抖音)",
    # 假设鲁迅活在今天
    r"(如果|假如|假设).*(鲁迅|你).*(活在|生活在|来到|穿越到).*(今天|现代|当代|现在|当下|202)",
    r"请用鲁迅的.*(评价|看待|谈谈|说说).*(现代|当今|现在|当下|如今|年轻人)",
    # 纪念馆 + 不可能的东西
